...
rule rseqc_junction_annotation:
    input:
        bam = "../data/processed/star/{sample}-{unit}/Aligned.sortedByCoord.out.bam",
        bed = "../qc/rseqc/annotation.bed"
    output:
...
rule multiqc:
    input:
        expand("../data/processed/star/{unit.sample}-{unit.unit}/Aligned.sortedByCoord.out.bam", unit=units.itertuples()),
        expand(
